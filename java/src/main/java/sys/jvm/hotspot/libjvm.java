	...
	public static final long JVM_GetCallerClass(long pJNIEnv)
	{
		...
		class __init
		{
			...
			static
			{
				...
				sys.jvm.hotspot.oops.Method _vm_getCallerClass = InstanceKlass.lookup_method(jdk_internal_reflect_Reflection, "getCallerClass", "()Ljava/lang/Class;");
				sys.jvm.hotspot.oops.Method _libjvm_JVM_GetCallerClass = InstanceKlass.lookup_method(libjvm.class, "JVM_GetCallerClass", "(J)J");
				sys.jvm.hotspot.oops.ConstMethodFlags flags = _libjvm_JVM_GetCallerClass.constMethod().flags();
